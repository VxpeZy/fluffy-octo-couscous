...
// Then add this endpoint for generating PromptPay QR codes

// Helper function to format PromptPay payload
function generatePromptPayPayload(phoneNumber, amount) {
  // This is a simplified version of the PromptPay format
  // In production, use a proper PromptPay library or follow the official spec

  // Format: ID|Phone Number|Amount
  const payload = `00020101021229370016A000000677010111${phoneNumber}5802TH53037645${amount}6304`;
